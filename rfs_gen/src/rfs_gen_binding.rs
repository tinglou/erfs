...
pub const RfsGenStatusCode_RFS_INVALID_INPUT: RfsGenStatusCode = -1;
pub const RfsGenStatusCode_RFS_NOT_FOUND: RfsGenStatusCode = -2;
pub const RfsGenStatusCode_RFS_NOT_FILE: RfsGenStatusCode = -3;
pub const RfsGenStatusCode_RFS_NOT_DIRECTORY: RfsGenStatusCode = -4;
pub const RfsGenStatusCode_RFS_OUTOF_BOUND: RfsGenStatusCode = -5;
